...
#include "controller_interface/msg/detail/control__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const controller_interface::msg::Control *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<controller_interface::msg::Control *>(
    untyped_ros_message);
...
{
  return &controller_interface::msg::typesupport_fastrtps_cpp::_Control__handle;
}
