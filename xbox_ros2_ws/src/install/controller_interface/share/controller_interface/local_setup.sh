...
: ${AMENT_CURRENT_PREFIX:="/home/cisco/xbox_ros2_ws/src/install/controller_interface"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/controller_interface/environment/pythonpath.sh"
